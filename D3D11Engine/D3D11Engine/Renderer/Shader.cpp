...
// ²Î¿¼ÁË£ºhttps://github.com/xamarin/Urho3D/blob/master/Source/Urho3D/Graphics/Direct3D11/D3D11ShaderVariation.cpp
Shader::Shader()
{
	m_vertexShader = NULL;
	m_pixelShader = NULL;
...
void Shader::CalculateConstantBufferSizes(ShaderType type_)
{
	...
	for (HashMap<unsigned, ShaderParameter>::iterator i = parameters_.begin(); i != parameters_.end(); ++i)
	{
